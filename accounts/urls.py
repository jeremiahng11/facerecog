...
urlpatterns = [
    ...
    path('cafeteria/admin/menu/bulk-import/', cafeteria_views.admin_menu_bulk_import_view, name='cafeteria_admin_menu_bulk_import'),
    path('cafeteria/admin/menu/template/', cafeteria_views.admin_menu_template_download_view, name='cafeteria_admin_menu_template'),
    ...
    path('cafeteria/admin/guides/<str:guide_type>/', cafeteria_views.user_guide_download_view, name='user_guide_download'),
    path('cafeteria/admin/vending-report/', cafeteria_views.admin_vending_report_view, name='admin_vending_report'),
    path('cafeteria/admin/vending-report/csv/', cafeteria_views.admin_vending_csv_view, name='admin_vending_csv'),
